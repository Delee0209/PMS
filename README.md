...
This is an implementation of Photon-Driven Manifold Sampling (PMS), based on the original [Specular Manifold Sampling (SMS) codebase](https://github.com/tizian/specular-manifold-sampling)
